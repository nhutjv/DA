...
<header class="header-section">
	...
	<div class="nav-options">
		<div class="container">
			<div class="nav-menu">
				<ul>
					<li class="active"><a href="/nhutnhpc05876_asm2/home"><span>Home</span></a></li>

					<li class="active"><a href="/nhutnhpc05876_asm2/video"><span>VIDEOS</span></a></li>

					<li class="active"><a href="/nhutnhpc05876_asm2/user"><span>USERS<i class=""></i>
						</span></a></li>
					<li><a href="#"><span>ACCOUNT <i
							...
							<c:choose>
								<c:when test="${!empty sessionScope.fullName}">
									...
									<c:if
										...
										<li><a class="dropdown-item" href="/nhutnhpc05876_asm2/home">Trang
												người dùng</a></li>
									</c:if>
									<li><a class="dropdown-item" href="/nhutnhpc05876_asm2/logout">Đăng
											xuất</a></li>
