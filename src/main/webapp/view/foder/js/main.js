...
(function ($) {
    ...
    // quên mật khẩu
    $('.forpass-switch').on('click', function () {
        $('.forpass-section').fadeIn(400);
    });

    $('.forpass-close').on('click', function () {
        $('.forpass-section').fadeOut(400);
    });
    //ĐỔI MẬT KHẨU
    $('.repass-switch').on('click', function () {
        $('.repass-section').fadeIn(400);
    });

    $('.repass-close').on('click', function () {
        $('.repass-section').fadeOut(400);
    });
    //cập nhật thông tin
    $('.update-switch').on('click', function () {
        $('.update-section').fadeIn(400);
    });

    $('.update-close').on('click', function () {
        $('.update-section').fadeOut(400);
    });
